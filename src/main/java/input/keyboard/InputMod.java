...
/**
 * Represents the modifiers when a key is pressed. Used to detect combinations like STRG+A;
 * <code>STRG+A</code> will be split up into <code>STRG</code> as modifier and <code>A</code> as the key pressed.
 *
 * @version 12.07.2021
 * @since 21.04.2021
 */
